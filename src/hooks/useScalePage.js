...
export default function useScalePage() {
    ...
    function triggerScale(option = {}) {
        ...
        // 1.拿到当前屏幕的宽高
        let currentX =
            document.documentElement.clientWidth || document.getElementById('main').clientWidth
        let currentY =
            document.documentElement.clientHeight || document.getElementById('main').clientHeight
