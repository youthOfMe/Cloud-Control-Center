        ...
        <el-row>
            ...
            <el-col :span="6">
                <div class="add_host fr">
                    ...
                    <a-button type="primary" style="margin-left: 20px" @click="showExcelModal()">
                        批量导入
                    </a-button>
                </div>
                <div class="clear"></div>
        ...
        >
            <template #bodyCell="{ column, text, record }">
                ...
                <template v-if="column.dataIndex === 'action'">
                    ...
                    >
                        <a style="margin-right: 10px">Delete</a>
                    </a-popconfirm>
                    <router-link :to="`/host/detail/${record.id}`" style="margin-right: 10px">
                        Details
                    </router-link>
                    <span class="request" @click="getHostMonitor(record.id)">Request</span>
                </template>
            </template>
        </a-table>
    </el-card>
...
import { reqCategoryList, reqHostList, delHost, addHost, reqHostMonitor } from '@/api/host'
